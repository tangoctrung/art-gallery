...
function Spotlight() {
  return (
    <section id="spotlight" className="h-full">
                  ...
                  >
                    <div className="absolute inset-0 flex items-center justify-center bg-(--art-surface-dark)">
                      <img
                        src={slide.image}
                        alt={slide.eyebrow}
                        className="homepage-motion homepage-motion-scale homepage-motion-delay-100 h-full w-full object-cover"
                      />
                    </div>
                    ...
                    <div className="absolute z-20 px-[5%] bottom-6 md:bottom-10 max-w-[90%] md:max-w-1/2">
                      <h2 className="homepage-motion homepage-motion-left homepage-motion-delay-180 text-3xl font-bold leading-9 mb-3 text-[var(--art-text-white-78)]">
                        {slide.eyebrow}
                      </h2>
                      <p className="homepage-motion homepage-motion-left homepage-motion-delay-260 text-base font-normal leading-5 text-[var(--art-text-white-50)]">
                        Tác giả: {slide.artist}
                      </p>
                      <div className="homepage-motion homepage-motion-up homepage-motion-delay-340 mt-6 flex flex-wrap gap-3">
                        <Link
                          href={`painting/1234`}

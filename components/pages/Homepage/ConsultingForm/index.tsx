...
function ConsultingForm() {
  return (
    <section
      id="consultation"
      className="flex h-full items-start overflow-y-auto bg-[var(--art-surface-light)] px-[5%] py-6 md:items-center md:py-10"
    >
      <div className="mx-auto grid w-full max-w-350 gap-6 lg:grid-cols-[0.92fr_1.08fr]">
        <div className="rounded-xl h-fit bg-[var(--art-surface-dark)] p-6 text-[var(--art-text-inverse)] md:p-8">
          ...
          <div className="mt-6 space-y-3 text-sm text-[var(--art-text-white-72)]">
        ...
        <form className="rounded-xl bg-[var(--art-surface-white)] p-5 shadow-[var(--art-shadow-panel)] md:p-7">
          <div className="grid gap-4 md:grid-cols-2">
            <label className="block">
              <span className="mb-2 block text-sm text-[var(--art-text-black-55)]">Họ và tên</span>
              <div className="flex items-center gap-3 rounded-2xl border border-[var(--art-border-dark)] bg-[var(--art-surface-form)] px-4 py-2.5">
            ...
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[var(--art-border-dark)] bg-[var(--art-surface-form)] px-4 py-2.5 text-sm focus:outline-none"
              />
            </label>
            ...
            <label className="block md:col-span-2">
              ...
              <textarea
                ...
                className="w-full rounded-3xl border border-[var(--art-border-dark)] bg-[var(--art-surface-form)] px-4 py-3 text-sm leading-6 focus:outline-none"
              />
            </label>
          </div>

          <div className="mt-5 flex flex-col flex-wrap items-start justify-between gap-4">
            <button
              type="submit"
